...
class acf_field_list_items extends acf_field {
	...
	*/
	...
	function render_field( $field ) {
		...
		// button label
		if( $field['button_label'] === '' ) $field['button_label'] = __( 'Add Item', 'acf-frontend-form-element' );
		if( $field['duplicate_label'] === '' ) $field['duplicate_label'] = __( 'Duplicate Item', 'acf-frontend-form-element' );
		if( $field['remove_label'] === '' ) $field['remove_label'] = __( 'Remove Item', 'acf-frontend-form-element' );
	...
	<tbody>
		<?php foreach( $value as $i => $row ): 
			...
			<tr class="<?php echo $css_classes ?>" data-id="<?php echo esc_attr( $id ); ?>">
				...
				<?php if( $show_order ): 
				$td_class = 'acf-row-handle order';
				if( $show_order == 'ids' ) $td_class .= '  ids'; ?>
					<td class="<?php echo $td_class; ?>" title="<?php _e('Drag to reorder','acf'); ?>">
...
<?php
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		// button_label
		acf_render_field_setting( $field, array(
			'label'			=> __('Add Item Label','acf'),
			'instructions'	=> '',
			'type'			=> 'text',
			'name'			=> 'button_label',
			'placeholder'	=> __('Add','acf')
		));
		// button_label
		acf_render_field_setting( $field, array(
			'label'			=> __('Remove Item Label','acf'),
			'instructions'	=> '',
			'type'			=> 'text',
			'name'			=> 'remove_label',
			'placeholder'	=> __('Remove','acf')
		));
