...
class ACF_Frontend_Forms
{
    ...
    function admin_head()
    {
        ...
        foreach ( $data_types as $type ) {
            add_meta_box(
                'acf-frontend-form-' . $type,
                __( ucfirst( $type ), 'acf-frontend-form-element' ),
                array( $this, 'mb_data' ),
                'acf_frontend_form',
                'side',
                'core',
        ...
        foreach ( $meta_boxes as $name ) {
            add_meta_box(
                'acf-frontend-form-' . $name,
                __( ucfirst( $name ), 'acf-frontend-form-element' ),
                array( $this, 'mb_' . $name ),
                'acf_frontend_form',
                'normal',
                'core'
    ...
    {
        // validate screen
        if ( !acf_is_screen( 'acf_frontend_form' ) ) {
            return;
        }
        // disable filters to ensure ACF loads raw data from DB
        acf_disable_filters();
