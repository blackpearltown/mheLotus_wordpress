...
<div class="wpsisac-slider-wrp wpsisac-clearfix <?php echo $extra_class; ?>" data-conf="<?php echo htmlspecialchars(json_encode($slider_conf)); ?>">
	<div id="wpsisac-pro-slick-slider-<?php echo $unique; ?>" class="wpsisac-slick wpsisac-slick-init wpsisac-slick-slider wpsisac-clearfix <?php echo $css_clr; ?>" <?php echo $slider_as_nav_for; ?>>