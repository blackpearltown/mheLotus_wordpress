...
<div class="wpsisac-slick-variable-wrp wpsisac-clearfix <?php echo $extra_class; ?>" data-conf="<?php echo htmlspecialchars(json_encode($slider_conf)); ?>">
	<div id="wpsisac-pro-slick-variable-<?php echo $unique; ?>" class="wpsisac-slick wpsisac-slick-init wpsisac-slick-variable <?php echo $css_clr; ?>" style="width:<?php echo $center_width; ?>;">