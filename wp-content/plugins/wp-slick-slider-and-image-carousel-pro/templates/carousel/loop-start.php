...
<div class="wpsisac-slick-carousal-wrp wpsisac-clearfix <?php echo $extra_class; ?>" data-conf="<?php echo htmlspecialchars(json_encode($slider_conf)); ?>">
	<div id="wpsisac-pro-slick-carousal-<?php echo $unique; ?>" class="wpsisac-slick wpsisac-slick-init wpsisac-slick-carousal wpsisac-slick-carousal-slider <?php echo $css_clr; ?>">