...
if( ! defined( 'WPSISAC_PRO_VERSION' ) ) {
	define( 'WPSISAC_PRO_VERSION', '1.6.4' ); // Version of plugin
}
...
if( ! defined( 'WPOS_HIDE_LICENSE' ) ) {
	define( 'WPOS_HIDE_LICENSE', 'info' ); // Plugin metabox prefix
}
...
function wpsisac_pro_plugins_loaded() {
	...
	if( $pagenow != 'widgets.php' && ( defined('ELEMENTOR_PLUGIN_BASE') || class_exists('SiteOrigin_Panels') || class_exists( 'FLBuilderModel' ) ) ) {
		require_once( WPSISAC_PRO_DIR . '/includes/widgets/shortcode/wpsisac-shortcode-widgets.php' );
	}
}
...
if( ! class_exists( 'EDD_SL_Plugin_Updater' ) ) {	
	include( WPSISAC_PRO_DIR . '/EDD_SL_Plugin_Updater.php' );
}
...
if ( is_admin() || ( defined( 'WP_CLI' ) && WP_CLI ) ) {
	...
	if( ! defined( 'WPOS_HIDE_LICENSE' ) || ( defined( 'WPOS_HIDE_LICENSE' ) && WPOS_HIDE_LICENSE != 'page' ) ) {
		include_once( WPSISAC_PRO_DIR . '/edd-slickslider-plugin.php' );
	}
}