...
class Wpsisac_Pro_Admin {
	...
	function __construct() {
		...
		add_action( 'save_post_'.WPSISAC_PRO_POST_TYPE, array($this, 'wpsisac_pro_save_metabox_value') );
	...
	function wpsisac_pro_admin_processes() {
		...
		// If plugin notice is dismissed
		if( isset( $_GET['message'] ) && $_GET['message'] == 'wp-tsasp-license-exp-notice' ) {
			set_transient( 'wp_tsasp_license_exp_notice', true, 864000 );
		}
