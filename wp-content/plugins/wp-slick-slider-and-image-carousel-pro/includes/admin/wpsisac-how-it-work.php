							...
							<table class="form-table">
								<tbody>
									...
									<tr>
										...
										<td>
											<span class="wpos-copy-clipboard wpsisacm-shortcode-preview">[slick-slider]</span> – <?php _e('Slick Slider', 'wp-slick-slider-and-image-carousel'); ?> <br />
											<span class="wpos-copy-clipboard wpsisacm-shortcode-preview">[slick-carousel-slider]</span> – <?php _e('Slick Carousel Slider', 'wp-slick-slider-and-image-carousel'); ?> <br />
											<span class="wpos-copy-clipboard wpsisacm-shortcode-preview">[slick-variable-slider]</span> – <?php _e('Slick Variable Slider', 'wp-slick-slider-and-image-carousel'); ?> <br />
											<br/><br/>
				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full" href="<?php echo esc_url('https://docs.wponlinesupport.com/wp-slick-slider-and-image-carousel-pro/?utm_source=slick_slider_pro&utm_medium=Slick_Sliders&utm_campaign=getting_started'); ?>" target="_blank"><?php _e('Documentation', 'wp-slick-slider-and-image-carousel'); ?></a>
							<p><a class="button button-primary wpos-button-full" href="<?php echo esc_url('https://demo.wponlinesupport.com/prodemo/pro-wp-slick-slider-and-carousel-demo/?utm_source=slick_slider_pro&utm_medium=Slick_Sliders&utm_campaign=getting_started'); ?>" target="_blank"><?php _e('Demo for Designs', 'wp-slick-slider-and-image-carousel'); ?></a></p>
						</div><!-- .inside -->
					</div><!-- .postbox -->
					...
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<p><a class="button button-primary wpos-button-full" href="<?php echo esc_url('https://www.wponlinesupport.com/wordpress-support/?utm_source=slick_slider_pro&utm_medium=Slick_Sliders&utm_campaign=getting_started'); ?>" target="_blank"><?php _e('Know More', 'wp-slick-slider-and-image-carousel'); ?></a></p>
						</div><!-- .inside -->
					</div><!-- .postbox -->
