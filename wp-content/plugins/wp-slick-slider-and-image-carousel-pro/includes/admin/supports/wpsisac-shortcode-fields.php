 ...
 * @since 1.3.3
 */
function slick_slider_shortcode_fields() {
	...
	$fields = array(
			...
			'general' => array(
					...
					'params'   	=>  array(
									...
									array(
										'type' 		=> 'dropdown',
										'heading' 	=> __( 'Show Title', 'wp-slick-slider-and-image-carousel' ),
										'name' 		=> 'show_title',
										'value' 	=> array(
															'true'	=> __( 'True', 'wp-slick-slider-and-image-carousel' ),
															'false'	=> __( 'False', 'wp-slick-slider-and-image-carousel' ),
														),
										'desc' 		=> __( 'Show title.', 'wp-slick-slider-and-image-carousel' ),
									),
									array(
										'type' 		=> 'dropdown',
 ...
 * @since 1.3.3
 */
function slick_carousel_slider_shortcode_fields() {
 ...
 * @since 1.3.3
 */
function slick_variable_slider_shortcode_fields() {
