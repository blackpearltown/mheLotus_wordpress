...
function wpsisac_pro_slick_slider( $atts, $content = null ) {
	...
	if( isset( $_POST['action'] ) && ($_POST['action'] == 'so_panels_layout_block_preview' || $_POST['action'] == 'so_panels_builder_content_json') ) {
		return '<div class="wpsisac-builder-shrt-prev">
					<div class="wpsisac-builder-shrt-title"><span>'.esc_html__('Slick Slider View - Shortcode', 'wp-slick-slider-and-image-carousel').'</span></div>
					[slick-slider]
				</div>';
	}
	...
	// WP Query Parameters
	$args			= apply_filters( 'slick_slider_query_args', $args, $atts );
